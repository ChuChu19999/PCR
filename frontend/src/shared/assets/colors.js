export const colors = {
  dark: {
    ...
    row_hovered: '#E9F7FF',
    sidebar_gradient_lvl_1: 'linear-gradient(180deg, rgb(0, 121, 194) 40%, rgb(0, 74, 119))',
    sidebar_gradient_lvl_2: 'linear-gradient(180deg, rgb(0, 158, 225) 40%, rgb(0, 74, 119))',
    sidebar_gradient_lvl_3: 'linear-gradient(180deg, rgb(123, 174, 208) 40%, rgb(0, 74, 119))',
    color_text: '#282828',
    none: 'rgba(0,0,0,0)',
    border_color: '#BABFC7',
    links: '#2196F3',
  ...
  light: {
    ...
    row_hovered: '#E9F7FF',
    sidebar_gradient_lvl_1: 'linear-gradient(180deg, rgb(0, 121, 194) 40%, rgb(0, 74, 119))',
    sidebar_gradient_lvl_2: 'linear-gradient(180deg, rgb(0, 158, 225) 40%, rgb(0, 112, 159))',
    sidebar_gradient_lvl_3: 'linear-gradient(180deg, rgb(123, 174, 208) 40%, rgb(94, 133, 159))',
    color_text: '#282828',
    none: 'rgba(0,0,0,0)',
    border_color: '#BABFC7',
    links: '#2196F3',
